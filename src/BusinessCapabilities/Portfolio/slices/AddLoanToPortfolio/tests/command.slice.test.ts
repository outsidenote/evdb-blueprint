...
describe("AddLoanToPortfolio Slice - Unit Tests", () => {
  ...
  test("spec: portfolioRatingBreached", async () => {
    const givenEvents: TestEvent[] = [
      {
        ...
        payload: {
          ...
          // Existing portfolio has BBB (investment grade, rank=4)
          creditRating: "BBB",
          interestRate: 5,
          loanAmount: 10000000,
          loanId: "loan-acme-001",
    ...
    const command: AddLoanToPortfolio = {
      ...
      portfolioId: "port-001",
      acquisitionDate: new Date("2025-01-01T11:00:00Z"),
      // CCC (rank=7) > BBB (rank=4) → portfolioRatingBreached fires
  ...
  test("spec: portfolioRatingMaintained", async () => {
    const givenEvents: TestEvent[] = [
      {
        ...
        payload: {
          ...
          acquisitionDate: new Date("2025-01-01T11:00:00Z"),
          borrowerName: "Acme Corp",
          // Existing portfolio has BBB (rank=4)
          creditRating: "BBB",
          interestRate: 5,
          loanAmount: 10000000,
          loanId: "loan-acme-001",
    ...
    const command: AddLoanToPortfolio = {
      ...
      portfolioId: "port-001",
      acquisitionDate: new Date("2025-01-01T11:00:00Z"),
      // BBB (rank=4) <= BBB (rank=4) → portfolioRatingMaintained fires
