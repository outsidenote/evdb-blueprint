...
describe("Projection: PortfolioLoanDetails", () => {
  ...
  it("LoanRiskAssessed handler returns SQL statements", () => {
    ...
    assert.deepStrictEqual(params[4], new Date("2025-01-01T11:00:00Z"), "params[4] should be acquisitionDate");
    ...
    assert.deepStrictEqual(params[11], new Date("2025-01-01T11:00:00Z"), "params[11] should be maturityDate");
